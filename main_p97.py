...
fig.savefig('results/EUSIPCO/HMCNMA_emd_allatoms4'+str(number)+'.png', format='png', dpi=1000)
fit1.save(  'results/EUSIPCO/HMCNMA_emd_allatoms4'+str(number)+'_fit1.pkl')
fit2.save(  'results/EUSIPCO/HMCNMA_emd_allatoms4'+str(number)+'_fit2.pkl')
fit3.save(  'results/EUSIPCO/HMCNMA_emd_allatoms4'+str(number)+'_fit3.pkl')
